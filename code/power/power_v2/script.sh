...
pushd "../../cpu" > /dev/null
vcs -sverilog -full64 -kdb -debug_access+all -f ../power/power_v2/src.f system_top_with_cpu_tb.v +vcs+fsdbon -o simv | tee "../power/power_v2/$RESULTS_DIR/vcs_compile.log"
