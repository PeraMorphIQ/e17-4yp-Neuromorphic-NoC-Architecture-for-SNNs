...
if [ -d "$RTL_CPU_PATH" ]; then
    ...
    vcs -sverilog -full64 -kdb -debug_access+all cpu/cpu_tb.v +vcs+fsdbon -o simv | tee "../power/cpu_sky130_fd_sc_hd/$TEMP_RESULTS_DIR/vcs_compile.log"
    echo "VCS compilation completed successfully"
    
    # Step 2: Run Simulation
    echo "========== STEP 2: Run Simulation =========="
    ./simv +fsdb+all=on +fsdb+delta | tee "../power/cpu_sky130_fd_sc_hd/$TEMP_RESULTS_DIR/simulation.log"
