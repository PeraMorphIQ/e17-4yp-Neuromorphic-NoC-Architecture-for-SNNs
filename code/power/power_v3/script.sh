...
pushd "../../cpu" > /dev/null
vcs -sverilog -full64 -kdb -debug_access+all system_top_tb.v +vcs+fsdbon -o simv | tee "../power/power_v3/$RESULTS_DIR/vcs_compile.log"

# Step 2: Run Simulation
echo "========== STEP 2: Run Simulation =========="
./simv +fsdb+all=on +fsdb+delta | tee "../power/power_v3/$RESULTS_DIR/simulation.log"
popd > /dev/null
