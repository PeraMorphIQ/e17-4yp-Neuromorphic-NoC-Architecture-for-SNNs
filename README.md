...
![method](/docs/images/arch/method.png "Method")
...
![Core](/docs/images/arch/core.png "Core")
...
![NoC](/docs/images/NOC/NoC-NoC.drawio.png "NoC")
...
![NI](/docs/images/NOC/NoC-temp_NI.drawio.png "Network Interface")
...
![PKT_PROC](/docs/images/NOC/NoC-temp-pkt_proc.drawio.png "Packet Processing")
...
![IM](/docs/images/NOC/NoC-temp-input_module.drawio.png "Input Module")
...
![OM](/docs/images/NOC/NoC-temp-output_module.drawio.png "Output_Module")
...
![Router](/docs/images/NOC/NoC-temp-router.drawio.png "Router")
![CB](/docs/images/NOC/NoC-temp-router_crossbar.drawio.png "CrossBar ")
...
![NB](/docs/images/arch/bank.png "Neuron Bank")
...
![arch](/docs/images/arch/arch.png "Final Architecture")
...
![hard](/docs/images/arch/hard.png "Hardware Testing")
...
![neurons](/docs/images/arch/neurons.png "neurons")

### Experiment I - Single Core

Using a single core for the simulation of all the neurons. 

![EX1](/docs/images/NOC/NoC-temp-1.drawio.png "Experiment I")
...
![EX2](/docs/images/NOC/NoC-temp.drawio.png "Experiment II")
...
![EX3](/docs/images/NOC/NoC-temp-2.drawio.png "Experiment III")


## Results and Analysis


![results](/docs/images/arch/results.png "Results")
